---
description: 토스증권 Open API로 시세를 받거나 제약을 확인할 때
type: external
---
...
| 과거 데이터 | 국내 2022-11-23, 미국 2021-11-30 이후 | 과거 봉 수집 없음 |
...
- 캔들 수집에 정규장(15:30) 이후 시간외 봉이 섞임 — 1분봉(1m)은 20:00 KST 봉까지 제공됨
...
- 캔들 조회(`GET /api/v1/candles`)는 `before`·`count`(최대 200)로 과거 방향 페이지만 받으며 시작 시각을 주는 순방향 조회가 없음
